...
<div class="row">
	...
	<div class="col-md-4">
		<div class="mb-3">
			...
			<input name="instagram" type="text" class="form-control" placeholder="Instagram" value="<?php echo $instagram_sistema ?>">
		</div>
	</div>
		...
		<div class="mb-3">
			...
			<input name="twitter" type="text" class="form-control" placeholder="Twitter" value="<?php echo $twitter_sistema ?>">
		</div>
	</div>
		...
		<div class="mb-3">
			...
			<input name="cor" type="text" class="form-control" placeholder="#b3210e" value="<?php echo $cor_sistema ?>">
		</div>
	</div>
		...
		<div class="mb-3">
			...
			<input name="texto_rodape" type="text" class="form-control" placeholder="Serviço de qualidade, atendimento personalizado e garantia de excelência" value="<?php echo $texto_rodape ?>">
		</div>
	</div>
		...
		<div class="mb-3">
			...
			<input name="subtitulo_contato" type="text" class="form-control" placeholder="Preencha as informações abaixo para entrar em contato conosco!" value="<?php echo $subtitulo_contato ?>">
		</div>
	</div>
	...
	<div class="col-md-2 col-4">
		<div><img id="target-icone" src="../img/icone.jpg" width="50px" style="margin-top: 25px"></div>
	</div>
